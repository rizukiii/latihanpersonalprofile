                ...
                <div class="cd-horizontal-timeline loaded">
                    <div class="timeline">
                        <div class="events-wrapper">
                            <div class="events" style="width: 1800px;">
                                <ol>
                                    <li><a href="#0" data-date="16/01/2017" class="older-event selected" style="left: 120px;">16 Jan</a></li>
                    ...
                    <div class="events-content" style="height: 225px;">
                        <ol>
                            ...
                            $query = mysqli_query($connect, "SELECT * FROM `tb_keahlian` LIMIT 1");
                            while ($item = $query->fetch_object()): ?>
                            <li data-date="20/04/2017" class="selected">
                                <h4>
                                            <img class="rounded float-left m-r-15" width="40" alt="user" src="https://bootdey.com/img/Content/avatar/avatar3.png"> <?= $item->skill ?><br>
